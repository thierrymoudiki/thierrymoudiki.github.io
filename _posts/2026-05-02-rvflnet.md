...
Of course, this blog post is not a proof of the title. It's about [R package `rvflnet`](https://docs.techtonique.net/rvflnet/index.html). But you can appreciate the **high performance of RVFLs** on regression, classification and survival analysis, and notably on the controversial `Boston` dataset (performs on par with Random Forest or Gradient Boosting).

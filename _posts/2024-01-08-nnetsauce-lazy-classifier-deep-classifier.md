---
layout: post
title: "A classifier that's very accurate (and deep) Pt.2: there are > 90 classifiers in nnetsauce"
description: "nnetsauce version 0.16.2, examples of classifiers calibrated with Automated Machine Learning (AutoML)"
date: 2024-01-08
categories: [Python, R, QuasiRandomizedNN]
comments: true
---

Version `v0.16.2` of `nnetsauce` is now available on your favorite platforms: [PyPI](https://pypi.org/project/nnetsauce/), [conda](https://anaconda.org/conda-forge/nnetsauce) and [GitHub](https://github.com/Techtonique/nnetsauce) for Python; [R universe](https://techtonique.r-universe.dev/nnetsauce) and [GitHub](https://github.com/Techtonique/nnetsauce_r) for R. The updated documentation will be available next week (I've been using `keras-autodoc` so far for this purpose; it is now discontinued).

For **Windows users**: if you run into issues when trying to install `nnetsauce` (but you shouldn't): remember that you can use the [Windows Subsystem for Linux (WSL)](https://learn.microsoft.com/en-us/windows/wsl/install). 
...
This post is about **AutoML in nnetsauce** using its 90 _base_ classifiers, thus including **regression-based classifiers**. It's **a mix** of these resources: 

- This [PDF document](https://www.researchgate.net/publication/377227280_Regression-based_machine_learning_classifiers) describing the regression-based classifiers available in `nnetsauce`
- [Classification using linear regression](https://thierrymoudiki.github.io/blog/2021/09/26/python/quasirandomizednn/classification-using-regression)
...
The goal is to show that, with `nnetsauce`, it's possible to calibrate a large number of classifiers and select the _best_ one, using a few lines of code. AutoML for MTS (multivariate time series forecasting) and DeepMTS will be presented next week.

# 0 - Install packages

The notebook can be found on GitHub for reproducibility of the following results: [https://github.com/Techtonique/nnetsauce/blob/master/nnetsauce/demo/thierrymoudiki_080124_lazy_classifier_deep_classifier.ipynb](https://github.com/Techtonique/nnetsauce/blob/master/nnetsauce/demo/thierrymoudiki_080124_lazy_classifier_deep_classifier.ipynb).
...
<p>85 rows × 5 columns</p>
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-86b32c71-0896-458a-bcc5-b69058bab0b1')"
...
<div id="df-6b4014c5-e912-4b61-96c3-8359ed462a85">
  <button class="colab-df-quickchart" onclick="quickchart('df-6b4014c5-e912-4b61-96c3-8359ed462a85')"
...
![xxx]({{base}}/images/2024-01-08/2024-01-08-image1.png){:class="img-responsive"}    
...
<p>85 rows × 5 columns</p>
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-3bea81bc-3623-44ec-8e88-965f9c977822')"
            title="Convert this dataframe to an interactive table."
            style="display:none;">
...
<div id="df-7c7760b6-eb77-41ca-9366-6e928ccd6342">
  <button class="colab-df-quickchart" onclick="quickchart('df-7c7760b6-eb77-41ca-9366-6e928ccd6342')"
            title="Suggest charts"
            style="display:none;">
...
![xxx]({{base}}/images/2024-01-08/2024-01-08-image2.png){:class="img-responsive"}    
...
<p>83 rows × 5 columns</p>
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-dbb5be70-5b75-4b51-8237-577a5aa38063')"
            title="Convert this dataframe to an interactive table."
            style="display:none;">
...
<div id="df-209e4728-5693-48f8-ac9c-d85cfef7c7d9">
  <button class="colab-df-quickchart" onclick="quickchart('df-209e4728-5693-48f8-ac9c-d85cfef7c7d9')"
            title="Suggest charts"
            style="display:none;">
...
![xxx]({{base}}/images/2024-01-08/2024-01-08-image3.png){:class="img-responsive"}        
...
<p>83 rows × 5 columns</p>
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-a9868ef4-9d23-4e46-a2e0-d6213dab0aaf')"
            title="Convert this dataframe to an interactive table."
            style="display:none;">
...
<div id="df-878c0500-00db-44ed-a984-5bc8550cc8b8">
  <button class="colab-df-quickchart" onclick="quickchart('df-878c0500-00db-44ed-a984-5bc8550cc8b8')"
            title="Suggest charts"
            style="display:none;">
...
![xxx]({{base}}/images/2024-01-08/2024-01-08-image4.png){:class="img-responsive"}        
...
![xxx]({{base}}/images/2024-01-08/2024-01-08-image5.png){:class="img-responsive"}        
...
<p>85 rows × 5 columns</p>
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-55c2f1ca-af2a-4589-a499-343b560aa83f')"
            title="Convert this dataframe to an interactive table."
            style="display:none;">
...
<div id="df-a79af3bb-c425-4e50-8d49-e55002832ca5">
  <button class="colab-df-quickchart" onclick="quickchart('df-a79af3bb-c425-4e50-8d49-e55002832ca5')"
            title="Suggest charts"
            style="display:none;">
...
![xxx]({{base}}/images/2024-01-08/2024-01-08-image6.png){:class="img-responsive"}        
...
<p>85 rows × 5 columns</p>
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-a5b50224-e99d-4ea1-81f6-2867a2a74921')"
            title="Convert this dataframe to an interactive table."
            style="display:none;">
...
<div id="df-04e30921-b8be-4fa3-acea-a7d5e066843e">
  <button class="colab-df-quickchart" onclick="quickchart('df-04e30921-b8be-4fa3-acea-a7d5e066843e')"
            title="Suggest charts"
            style="display:none;">
...
![xxx]({{base}}/images/2024-01-08/2024-01-08-image7.png){:class="img-responsive"}        
...
<p>83 rows × 5 columns</p>
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-8e6cb6a7-621f-486c-b441-09425e8960e6')"
            title="Convert this dataframe to an interactive table."
            style="display:none;">
...
<div id="df-9ff997f6-eaa7-4d54-9c2d-884a07cc398c">
  <button class="colab-df-quickchart" onclick="quickchart('df-9ff997f6-eaa7-4d54-9c2d-884a07cc398c')"
            title="Suggest charts"
            style="display:none;">
...
![xxx]({{base}}/images/2024-01-08/2024-01-08-image8.png){:class="img-responsive"}        
...
<p>83 rows × 5 columns</p>
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-39c80f97-2dcc-45c3-b26e-2ad90c81509d')"
            title="Convert this dataframe to an interactive table."
            style="display:none;">
...
<div id="df-12d1f8a2-6297-498a-ab85-bf2f9927dbf4">
  <button class="colab-df-quickchart" onclick="quickchart('df-12d1f8a2-6297-498a-ab85-bf2f9927dbf4')"
            title="Suggest charts"
            style="display:none;">
...
![xxx]({{base}}/images/2024-01-08/2024-01-08-image9.png){:class="img-responsive"}        
...
![xxx]({{base}}/images/2024-01-08/2024-01-08-image10.png){:class="img-responsive"}    
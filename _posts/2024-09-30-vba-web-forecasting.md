---
layout: post
title: "Forecasting in Excel using Techtonique's Machine Learning APIs under the hood"
description: "Interacting with Techtonique web app through Excel, using Visual Basic for Applications (VBA)."
date: 2024-09-30
categories: Python
comments: true
---

I created a [basic Python FastAPI app](https://github.com/Techtonique/techtonique-xlwings-server) that allows you to **interact with [Techtonique web app](https://www.techtonique.net/) through Excel**. More specifically, Visual Basic for Applications (VBA) Excel. All you need to do is download the Excel file [VBA-Web.xlsm](https://github.com/thierrymoudiki/techtonique-excel-server), visit "Sheet1" and "Sheet2", and click the buttons. In "Sheet2", you should see something like this:

![xxx]({{base}}/images/2024-09-30/2024-09-30-image1.png){:class="img-responsive"}  

Keep in mind that these files are just demoes, and can be improved/beautified in **maaaany many different ways**. 

As a reminder, last week, I released [Techtonique web app](https://www.techtonique.net/), a tool designed to help you make informed, data-driven decisions using Mathematics, Statistics, Machine Learning, and Data Visualization. As of September 2024, the tool is in its beta phase (subject to crashes) and will remain completely free to use until December 24, 2024. 
